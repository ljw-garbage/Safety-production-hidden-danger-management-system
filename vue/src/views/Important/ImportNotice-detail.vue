    ...
    <div class="container">
        ...
        <div class="content" style="margin-top: 10px;color: #404040;">
            <div>
                ...
                <p style="color: #404040;font-size:16px;line-height: 25px;word-break: break-all;">特此公告</p>
                <p style="color: #404040;font-size:16px;line-height: 25px;word-break: break-all;">2021.4.30</p>
            </div>
        </div>
    ...
    export default {
        ...
        setup(){
            ...
            const getDetail=()=>{
                ...
                //
                // })
                request.get("/import-notice/"+id.value).then(res=>{
                    if(res.data){
                        // debugger
